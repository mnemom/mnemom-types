...
__export(index_exports, {
  ...
  CIRCUIT_BREAKER_MIN_BOUNDARY_COMPAT: () => CIRCUIT_BREAKER_MIN_BOUNDARY_COMPAT,
  CIRCUIT_BREAKER_MIN_REPUTATION: () => CIRCUIT_BREAKER_MIN_REPUTATION,
  COHERENCE_SUBWEIGHTS: () => COHERENCE_SUBWEIGHTS,
  COMPONENT_WEIGHTS: () => COMPONENT_WEIGHTS,
  CONFIDENCE_PENALTIES: () => CONFIDENCE_PENALTIES,
  GRADE_ORDINALS: () => GRADE_ORDINALS,
  GRADE_SCALE: () => GRADE_SCALE,
  INDIVIDUAL_RISK_WEIGHTS: () => INDIVIDUAL_RISK_WEIGHTS,
  RECENCY_HALF_LIFE_DAYS: () => RECENCY_HALF_LIFE_DAYS,
  RISK_THRESHOLDS: () => RISK_THRESHOLDS,
  TEAM_RECOMMENDATION_THRESHOLDS: () => TEAM_RECOMMENDATION_THRESHOLDS,
  TEAM_RISK_WEIGHTS: () => TEAM_RISK_WEIGHTS,
  VIOLATION_SEVERITY_WEIGHTS: () => VIOLATION_SEVERITY_WEIGHTS
});
